    ...
    <div class="gap-x-8 mx-auto max-w-2xl px-4 py-5 sm:px-6 sm:py-5 lg:max-w-7xl lg:px-8">
        ...
        <div class="flex gap-x-5 mt-3">
            ...
            <div class="flex-1">
                ...
                <div class="w-full">
                    <div class="grid grid-flow-col font-bold text-left">
                    ...
                    <div class="space-y-4">
                        @for ($i = 0; $i < 3; $i++)
                            <div class="flex justify-between items-center bg-white border rounded-lg p-4 shadow-sm hover:bg-gray-50">
                                ...
                                <x-ts-badge text="In stock" />

                                <div class="flex gap-x-5">
                                    <button class="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-2 text-base font-medium text-white shadow-xs hover:bg-indigo-700">
                                        Add to Cart
                                    </button>
